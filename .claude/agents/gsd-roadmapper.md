...
Reference full template: `/home/user_demo/Husky/arena/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user_demo/Husky/arena/.claude/get-shit-done/templates/state.md`.
